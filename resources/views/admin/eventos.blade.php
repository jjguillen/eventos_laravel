...
@section('main')
    <div class="container px-4 pt-24 mx-auto md:pt-32 lg:px-0 dark:bg-gray-900">
        ...
        <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700 mb-2">
            ...
            <x-button id="createProductButton" color="blue" ruta="{{ route('eventos.create') }}">
                Add new product
            </x-button>
        </div>
                        ...
                        <x-table.table>
                            ...
                            @foreach($eventos as $evento)
                                <x-table.tr>
                                    ...
                                    <x-table.td>
                                        <x-button id="updateProductButton" color="green">
                                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                            Update
                                        </x-button>
                                        <x-button id="deleteProductButton" color="red" ruta="{{ route('eventos.delete' , ['evento' => $evento->id]) }}">
